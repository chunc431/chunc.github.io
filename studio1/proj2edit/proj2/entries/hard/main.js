...
function page(candies, fetchNextPage){
  candies.forEach(
    function (candy) {
      let sweetImgs = document.createElement("div");
      let sweetDates = document.createElement("div");
      sweetImgs.classList.add("sweet-Imgs");
      sweetDates.classList.add("sweet-Dates");
      sweetImgs.setAttribute("data-Price", candy.fields.Price);
      ...
      sweetImgs.append(sweetImg);
      sweetDates.append(sweetDate);

      document.querySelector('.sweet-image').appendChild(sweetImgs);
      document.querySelector('.sweet-date').appendChild(sweetDates);
